...
import { createTenantCollectionsForNewUser } from "@/services/collections-service"
...
const login = async (
  ...
  if (loginResponse.success) {
    ...
    // console.log('getTenantResponse: ', getTenantResponse)

    const { data: { data: tenantData } } = getTenantResponse
...
const register = async (
  ...
  const {role, collections} = await createTenantCollectionsForNewUser(email)
...
export {
  forgotPassword, getCurrentUser, login, logout, passwordReset, register
}
